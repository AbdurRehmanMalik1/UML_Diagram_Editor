...
public class IncludeLineTest extends JavaFxTestBase {

    private Pane parentPane;
    private AssociationModel associationModel;
    private UMLObject startObject;
    private UMLObject endObject;
    private Include line;
    ...
    public void setUp() {
        ...
        line = new Include(0, 0, 100, 100, parentPane, associationModel, startObject, endObject);
