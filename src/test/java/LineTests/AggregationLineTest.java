...
public class AggregationLineTest extends JavaFxTestBase {

    private Pane parentPane;
    private AssociationModel associationModel;
    private UMLObject startObject;
    private UMLObject endObject;
    private Aggregation line;
    ...
    public void setUp() {
        ...
        endObject = new InterfaceObject();

        line = new Aggregation(0, 0, 100, 100, parentPane, associationModel, startObject, endObject);
