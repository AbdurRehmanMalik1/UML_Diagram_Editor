...
public class AssociationLineTest extends JavaFxTestBase {

    private Pane parentPane;
    private AssociationModel associationModel;
    private UMLObject startObject;
    private UMLObject endObject;
    private Association line;
    ...
    public void setUp() {
        ...
        line = new Association(0, 0, 100, 100,parentPane,associationModel,startObject,endObject);
