...
public class CompositionLineTest extends JavaFxTestBase {

    private Pane parentPane;
    private AssociationModel associationModel;
    private UMLObject startObject;
    private UMLObject endObject;
    private Composition line;
    ...
    public void setUp() {
        ...
        line = new Composition(0, 0, 100, 100, parentPane, associationModel, startObject, endObject);
